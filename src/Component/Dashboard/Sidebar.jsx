...
const Sidebar = () => {
    return (
        <div className="bg-[#FAF1E6]  h-screen flex flex-col justify-between p-4 open-sns">
            {/* Logo Section */}
            ...
            <NavLink to="/dashboard" className={({ isActive }) => "flex items-center justify-between w-[280px]"}>
        {({ isActive }) => (
