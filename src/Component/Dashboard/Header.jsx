...
const Header = () => {
    return (
        <div className="flex items-center justify-between p-6 bg-white dark:bg-[#374151] text-[#020202] dark:text-white">
        {/* Title */}
     <div></div>
       ...
       1
          ...
          >
            ...
            <img
         src={ "https://res.cloudinary.com/dhlgk023u/image/upload/v1738496016/9334243_puz7m4.jpg"}
              alt="Profile"
