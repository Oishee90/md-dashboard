...
const OrderList = () => {
    ...
    return (
        <div className="container mx-auto">
               <div className="flex items-center justify-between pt-2"> <h1 className="text-2xl font-bold mb-4">Order List</h1>
                  <div className="p-4   ">
                  ...
                  <select className="bg-[#F8F8F8] text-[#595D62] text-sm pl-2 pr-6 py-1 cursor-pointer outline-none appearance-none">
                    ...
                    <option value="Pin">Confirm</option>
                    <option value="Save">Pending</option>
                    <option value="Save">Cancel</option>
                  </select>
        ...
        <tbody>
          {subscribers.map((subscriber, index) => (
            <tr key={index} className="hover:bg-gray-50">
              ...
              <td className="py-2 px-6 text-left text-[#707070]">{subscriber.status}</td>
              ...
              <button
                  ...
                  className="text-[#555555] hover:text-[#424242] cursor-pointer"
                >
