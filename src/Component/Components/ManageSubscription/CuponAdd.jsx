...
const CuponAdd = () => {
    ...
    return (
        ...
        <div className="w-1/2">
          <button onClick={handleCreate} className="bg-[#8CAB91] w-full text-center text-white px-9 py-3 rounded-full text-lg font-semibold hover:bg-[#6C8B74] transition cursor-pointer">
            CREATE
          </button>
        </div>
      </div>
