...
const SubscriptionEditForm = () => {
    ...
    return (
        <div className="flex flex-col items-center px-4 w-1/2 container mx-auto bg-white py-4">
         ...
         <div>
           ...
           <div className="calender">
             ...
             /></div>
           <FaRegCalendarAlt
                     selected={endDate} className="absolute top-1/2 transform -translate-y-1/2 right-[5%] text-[#8CAB91] cursor-pointer"
     ...
     <div className="w-1/2">
       <button  onClick={handleEdit} className="bg-[#8CAB91] w-full text-center text-white px-9 py-3 rounded-full text-lg font-semibold hover:bg-[#6C8B74] transition">
        Update
       </button>
     </div>
   </div>
